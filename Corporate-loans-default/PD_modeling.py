...
# =============================================================================
# Load data frame for EDA analysis 
# =============================================================================
...
# convert 1 into 0 and 0 into 1 to adjust target values
def names(x):
    '''
...
df_final_join['Target_var'] = (df_final_join['Target'].apply(lambda x: names(str(x)))).drop('Target', axis=1)
...
# =============================================================================
# Ranking the score according to Moody's standards
# =============================================================================
